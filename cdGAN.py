    ...
    def train_model(self, load_dir):
        ...
        for epoch in range(1, self.n_epochs+1):   
            ...
            for idx in range(n_batches):
                ...
                cl_err = 0.01 * torch.mean(torch.log(preds + 1e-6))
...
def main():
    ...
    parser.add_argument("--run_name", default= "cdgan_a=0.01_log_2600_conditions_no_len_division_no_std", help="Name for output files")
