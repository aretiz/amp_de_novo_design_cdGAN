...
class WGAN_LangGP():
    def __init__(self, batch_size=64, lr=0.0001, num_epochs=150, seq_len = 156, data_dir='./data/multi_task_train.fasta', \
        run_name='test', hidden=512, d_steps = 10, max_examples=3600):
        ...
        self.checkpoint_dir = './checkpoint_MLP/' + run_name + "/"
    ...
    def load_model(self, directory='', iteration=None):
        ...
        self.G.load_state_dict(torch.load(G_file, weights_only='True'))
        return epoch_found
...
def main():
    ...
    parser.add_argument("--run_name", default="cdGAN-MLT", help="Name for output files")
    parser.add_argument("--load_dir", default="./checkpoint_cdGAN_mlt/", help="Load pretrained GAN checkpoints")
    parser.add_argument("--output_file", default="generated_samples_cdGAN_mlt.txt", help="Output file to save generated samples")
