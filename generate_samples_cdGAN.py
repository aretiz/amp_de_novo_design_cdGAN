...
def main():
    ...
    parser.add_argument("--run_name", default="MLP", help="Name for output files")
    parser.add_argument("--load_dir", default="./checkpoint_cdGAN/", help="Load pretrained GAN checkpoints")
    parser.add_argument("--output_file", default="generated_samples_cdGAN.txt", help="Output file to save generated samples")
